...
import com.iesvdc.acceso.entidades.Alumno;
 ...
 */
@Stateless
@Path("com.iesvdc.acceso.entidades.alumno")
public class AlumnoFacadeREST extends AbstractFacade<Alumno> {

    @PersistenceContext(unitName = "GA-JPAPU")
    private EntityManager em;

    public AlumnoFacadeREST() {
        super(Alumno.class);
        this.em = Persistence.createEntityManagerFactory("GA-JPAPU").createEntityManager();
    }
